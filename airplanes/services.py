...
def calculate_fuel_tank_capacity(airplane_id):
    return 200 * airplane_id


def calculate_total_fuel_consumption(airplane_id, num_of_passengers):
...
def calculate_max_flight_length(fuel_tank_capacity, total_fuel_consumption_per_minute):
